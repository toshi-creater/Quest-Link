...
async function main() {
  ...
  const roomDefs: RoomDef[] = [
    ...
    },
    {
      ...
      status: "full",
      tags: ["hardcore", "late_night"],
      members: ["shadow_ren", "rage_kenta", "thunder_kai"],
    },
    {
      ...
      members: ["burst_sora", "swift_ryota", "storm_jin", "player_bob"],
    },
    {
      ...
      members: ["blade_yuki", "sakura_fps", "omega_ryu", "venom_akira", "gamer_alice"],
    },
    {
      title: "原神 協力クエスト満員",
      game: "原神",
      host: "aurora_nana",
      maxPlayers: 4,
      description: "4人集まりました！",
      status: "full",
      tags: ["casual", "weekend", "platform_mobile"],
      members: ["aurora_nana", "crystal_rui", "delta_mei", "lunar_kei"],
    },
    {
      ...
      status: "full",
      tags: ["hardcore", "adult_only", "voice_chat"],
      members: ["zenith_tomo", "neon_taka", "cyber_nao", "rage_kenta", "blade_yuki"],
    },
    {
      title: "OW2 女性フルパ 練習中",
      game: "オーバーウォッチ",
    ...
    // ── closed × 7 ───────────────────────────────────────────────────────────
    {
      ...
      status: "closed",
      tags: ["casual"],
      members: ["nova_charlie", "player_bob"],
    },
    {
      title: "学生ゲーマー Apex（終了）",
      game: "エーペックスレジェンズ",
      host: "lunar_kei",
      maxPlayers: 3,
      description: "",
      status: "closed",
      tags: ["student", "casual"],
      members: ["lunar_kei", "delta_mei", "azure_shun"],
    },
    {
    ...
    },
    {
      ...
      status: "closed",
      tags: ["casual", "morning"],
      members: ["starlight_ai", "burst_sora"],
    },
    {
      title: "スプラ3 学生フレンド（終了）",
      game: "マーベル・ライバルズ",
      host: "vertex_rio",
      maxPlayers: 4,
      description: "",
    ...
    },
    {
      ...
      status: "closed",
      tags: ["casual", "beginner_friendly"],
      members: ["delta_mei", "lunar_kei"],
    },
  ];

  // べき等シード対応: 既存ルームデータをクリア
